%%
function ssq = peakfitmin(par,rate,temp,p,q,r,nu_eff,nu_eff1,nu_eff2,w_r)
% controls how ssq is minimised. 

    lfit_val = fit_output_nobase(temp,par(1,1),par(2,1),par(3,1),p,q,r,nu_eff,nu_eff1,nu_eff2,w_r);
